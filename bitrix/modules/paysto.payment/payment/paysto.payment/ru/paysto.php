...
$MESS['SALE_PAYSTO_PAID_STATUS_DESC'] = 'Для смены статуса в настройках расширенного счета установите Pay URL: http://ваш_сайт/PAYSTO/PAYSTO_notification.php в этом случае заказ получит указанный статус после успешной оплаты';
...
$MESS['SALE_PAYSTO_ONLY_FROM_IPS_DESC'] = 'Принимать обратные вызовы только с IP 95.213.209.218 95.213.209.219 95.213.209.220 95.213.209.221 95.213.209.222 для повышения безопасности';
